...
const FAQ = () => {
  ...
  const faqData: FAQ[] = [
    ...
    },
    {
      ...
      answer:
        'Safety is a major focus at SMMGen. Our SMM Panel is entirely secure and follows all terms of service of social media platforms. We employ genuine marketing methods to guarantee that your accounts stay safe and your social media growth is natural and lasting.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer:
        "At SMMGen, customer satisfaction is our top priority. If, for any reason, you are not content with our services, we provide a clear refund policy. Don't hesitate to contact our customer support with any concerns, and we will strive to address them, including issuing a refund if applicable.",
    },
    {
      id: 10,
  ...
  return (
    <section
      id="faq_v2"
      className="pt-[60px] pb-[120px] bg-white dark:bg-[#0d0712] transition-colors duration-200"
    >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {faqData.map((faq, index) => (
              ...
              >
                <button
                  className={`w-full text-left p-4 font-semibold text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-all duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)] dark:focus:ring-[var(--secondary)] ${
                    openItem === faq.id
                      ? 'bg-[var(--primary)]/10 dark:bg-[var(--secondary)]/20 text-[var(--primary)] dark:text-[var(--secondary)]'
                      : ''
                  }`}
                ...
                >
                  <div className="flex justify-between items-center">
                    <span className="text-sm lg:text-base pr-4 transition-colors duration-200">
                      {faq.question}
                    </span>
                    <svg
                      className={`w-5 h-5 transform transition-all duration-200 flex-shrink-0 ${
                        openItem === faq.id
                          ? 'rotate-180 text-[var(--primary)] dark:text-[var(--secondary)]'
