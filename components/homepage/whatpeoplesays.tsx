...
const WhatPeopleSays = () => {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content:
        "Teaming up with SMMGen has been a game-changer for our online presence. Their budget-friendly SMM panels have amplified our engagement and notably expanded our customer base. The team's expertise and personalized strategies are precisely what we require. Highly recommended for any business aiming to make a mark on social media!",
      rating: 5,
    },
    {
      id: 2,
      ...
      company: 'MCA',
      content:
        "SMMGen has transformed our social media strategy. Their Instagram and Facebook marketing approach has elevated our brand's visibility to new heights. The results have been outstanding – more engagement, followers, and conversions. Their service is top-notch and incredibly budget-friendly.",
      rating: 5,
    },
    {
      id: 3,
      ...
      content:
        "As a small business, we sought cost-effective yet impactful social media marketing, and SMMGen delivered beyond our expectations. Their YouTube and TikTok SMM panels have greatly helped increase our online influence. The team's professionalism and quick response to our needs make them a valuable partner.",
      rating: 5,
    },
    {
      id: 4,
      ...
      content:
        "Working with SMMGen has exceeded our expectations. Their comprehensive social media solutions have helped us achieve remarkable growth across all platforms. The ROI we've seen from their services is exceptional, and their customer support is always responsive and helpful.",
      rating: 5,
    },
    {
      id: 5,
      ...
      content:
        "SMMGen's expertise in social media marketing is unmatched. They've helped us build a strong online community and significantly increase our brand awareness. Their strategic approach and attention to detail have made them an invaluable partner for our business growth.",
      rating: 5,
    },
    {
      id: 6,
      ...
      content:
        'The results speak for themselves - since partnering with SMMGen, our social media engagement has tripled, and our conversion rates have improved dramatically. Their team understands our industry and delivers tailored solutions that drive real business results.',
      rating: 5,
    },
  ];
  ...
  return (
    <section
      id="testimonials_v2"
      className="pt-[60px] pb-[60px] relative bg-white dark:bg-[#0d0712] transition-colors duration-200"
    >
