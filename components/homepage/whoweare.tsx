...
const WhoWeAre: React.FC = () => {
  return (
    <section id="default_sections_v2" className="about-us pt-[60px] pb-[60px] bg-white dark:bg-[#0d0712] transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="default__text__content">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight transition-colors duration-200">
              ...
              Media <span className="text-[#5F1DE8] dark:text-[#B131F8] transition-colors duration-200">Enhancement</span>
            </h2>
          ...
          <div className="default_image text-center lg:text-right">
            <div className="relative group">
              <Image
                ...
                width={600}
                height={500}
                className="w-full max-w-lg mx-auto lg:mx-0 rounded-lg shadow-lg dark:shadow-lg dark:shadow-black/20 transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl dark:group-hover:shadow-purple-500/10"
                priority
              />
