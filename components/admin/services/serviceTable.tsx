  ...
  const filteredServices = useMemo(() => {
    ...
    let filtered = data.data.filter((service: any) => {
      ...
      if (filterStatus === 'updated')
        return matchesSearch && service.updateText;
    ...
    <Fragment>
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground">
          <span>
            Showing {filteredServices.length} of {data?.data?.length || 0}{' '}
            services
            {searchTerm && (
            ...
            {filteredServices.length === 0 ? (
              ...
              filteredServices.map((service: any, i: number) => (
                ...
                >
                  ...
                  <TableCell>{getServiceStatusBadge(service)}</TableCell>
                  <TableCell>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-muted/20 rounded-lg border">
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span>
                {
                  filteredServices.filter((s: any) => s.status === 'active')
                    .length
                }{' '}
                Active
              </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {
                  filteredServices.filter((s: any) => s.status === 'inactive')
                    .length
                }{' '}
                Inactive
              </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {filteredServices.filter((s: any) => s.updateText).length}{' '}
                Updated
              </span>
            </div>
            <div className="flex items-center gap-2">
