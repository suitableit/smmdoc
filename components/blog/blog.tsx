...
const Section: React.FC<SectionProps> = ({ children, className = '' }) => (
  <section className={`bg-white dark:bg-[#0d0712] transition-colors duration-200 ${className || 'pb-[30px]'}`}>
...
const BlogPage: React.FC = () => {
  ...
  const allBlogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: 'Consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco.',
    ...
    },
    {
      ...
      excerpt: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.',
    ...
    },
    {
      ...
      excerpt: 'Tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    ...
    },
    {
      ...
      excerpt: 'Ut labore et dolore magna aliqua. Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure.',
    ...
    },
    {
      ...
      excerpt: 'Magna aliqua ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit.',
    ...
    },
    {
      ...
      excerpt: 'Ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate.',
    ...
    },
    {
      ...
      excerpt: 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore.',
    ...
    },
    {
      ...
      excerpt: 'Exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore eu fugiat.',
    ...
    },
    {
      ...
      excerpt: 'Laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore eu fugiat nulla pariatur.',
    ...
    },
    {
      ...
      excerpt: 'Ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint.',
    ...
    },
    {
      ...
      excerpt: 'Ex ea commodo consequat duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.',
      ...
      <Section className="pt-[120px]">
        <div className="text-center">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white leading-tight mb-6 transition-colors duration-200">
            ...
            <span className="text-[#5F1DE8] dark:text-[#B131F8] transition-colors duration-200">Social Media</span> Strategies
          </h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed max-w-4xl mx-auto transition-colors duration-200">
            Welcome to SMMGen's blog page. Your gateway to the latest insights and trends in social media marketing.
            This resource outlines how we share knowledge, provide valuable content, and help you stay ahead in the
            digital marketing landscape with cutting-edge strategies and expert guidance.
          </p>
        </div>
      </Section>
        ...
        {!hasMorePosts && allBlogPosts.length > 6 && (
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-300 text-lg transition-colors duration-200">
              You've reached the end of our blog posts. Stay tuned for more updates!
            </p>
          </div>
        )}
      </Section>
