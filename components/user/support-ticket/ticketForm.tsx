...
const TicketPage: React.FC = () => {
  ...
  const handleticketsHistoryClick = () => {
    ...
    window.location.href = '/user/tickets-history';
  };
    ...
    <div className="page-container">
      ...
      <div className="page-content">
        ...
        <div className="page-header">
          <h1 className="page-title">Support Ticket</h1>
          <p className="page-description">
            Need assistance? Create a support ticket and get the help you need
            from our dedicated support team. Whether you're facing technical
            issues, have questions about our services, or need guidance, we're
            here to assist you.
          </p>
        </div>
