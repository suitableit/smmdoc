        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <p className="text-3xl font-bold text-gray-800">{stats.totalUsers || 1}</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-emerald-50 to-green-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <p className="text-3xl font-bold text-gray-800">{formatCurrency(stats.totalRevenue || 0)}</p>
                  <TrendingUp className="h-4 w-4 text-green-500" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-cyan-50 to-blue-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <p className="text-3xl font-bold text-gray-800">{formatCurrency(stats.totalPayment || 0)}</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-rose-50 to-pink-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                ...
                <p className="text-xs text-rose-600 font-medium">Daily Earnings</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-teal-50 to-emerald-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                ...
                <p className="text-xs text-teal-600 font-medium">Fresh Orders</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-indigo-50 to-purple-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                ...
                <p className="text-xs text-indigo-600 font-medium">Fresh Registrations</p>
              </div>
      ...
      <div className="mb-8">
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-white to-purple-50 shadow-xl hover:shadow-2xl transition-all duration-300">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <a href="/dashboard/admin/funds" className="group relative overflow-hidden p-6 border-0 rounded-xl bg-gradient-to-br from-emerald-50 to-green-100 hover:from-emerald-100 hover:to-green-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-green-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="text-center relative z-10">
                  ...
                  <p className="font-bold text-gray-800 text-lg mb-2">Manage Funds</p>
                  <p className="text-sm text-gray-600">View all transactions</p>
                </div>
              </a>
              <a href="/dashboard/admin/users" className="group relative overflow-hidden p-6 border-0 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 hover:from-blue-100 hover:to-indigo-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="text-center relative z-10">
                  ...
                  <p className="font-bold text-gray-800 text-lg mb-2">Manage Users</p>
                  <p className="text-sm text-gray-600">User management</p>
                </div>
              </a>
              <a href="/dashboard/admin/orders" className="group relative overflow-hidden p-6 border-0 rounded-xl bg-gradient-to-br from-amber-50 to-yellow-100 hover:from-amber-100 hover:to-yellow-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="text-center relative z-10">
                  ...
                  <p className="font-bold text-gray-800 text-lg mb-2">Manage Orders</p>
                  <p className="text-sm text-gray-600">View all orders</p>
                </div>
              </a>
              <a href="/dashboard/admin/services" className="group relative overflow-hidden p-6 border-0 rounded-xl bg-gradient-to-br from-rose-50 to-pink-100 hover:from-rose-100 hover:to-pink-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                <div className="absolute inset-0 bg-gradient-to-r from-rose-500/10 to-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="text-center relative z-10">
                  ...
                  <p className="font-bold text-gray-800 text-lg mb-2">Manage Services</p>
                ...
                <div className="h-[300px] flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl border-2 border-dashed border-gray-300">
                  {stats.recentOrders && stats.recentOrders.length > 0 ? (
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 font-medium">Interactive Chart will be displayed here</p>
                      <p className="text-sm text-gray-500">Real-time order analytics</p>
                    </div>
                  ) : (
                    <div className="text-center">
                      <PieChart className="h-16 w-16 text-gray-400 mx-auto mb-4" />
                      <p className="text-gray-600 font-medium">No recent orders to display</p>
                      <p className="text-sm text-gray-500">Charts will appear when data is available</p>
                    </div>
                  )}
                </div>
              </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <div className="h-[200px] flex items-center justify-center bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl border-2 border-dashed border-gray-300">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 font-medium text-sm">Statistics chart</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-blue-700 transition-colors duration-300">0</p>
                  <div className="bg-blue-100 p-1 rounded-full group-hover:bg-blue-200 transition-colors duration-300">
                    <TrendingUp className="h-3 w-3 text-blue-600" />
                  </div>
                </div>
                <p className="text-sm font-semibold text-gray-700 group-hover:text-blue-800 transition-colors duration-300">Total Orders</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-emerald-700 transition-colors duration-300">0</p>
                  <div className="bg-emerald-100 p-1 rounded-full group-hover:bg-emerald-200 transition-colors duration-300">
                    <CheckIcon className="h-3 w-3 text-emerald-600" />
                  </div>
                </div>
                <p className="text-sm font-semibold text-gray-700 group-hover:text-emerald-800 transition-colors duration-300">Completed</p>
                <p className="text-xs text-emerald-600 font-medium">Successfully finished</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-amber-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-amber-800 transition-colors duration-300">Processing</p>
                <p className="text-xs text-amber-600 font-medium">Currently in progress</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-cyan-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-cyan-800 transition-colors duration-300">Pending</p>
                <p className="text-xs text-cyan-600 font-medium">Awaiting processing</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-violet-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-violet-800 transition-colors duration-300">In Progress</p>
                <p className="text-xs text-violet-600 font-medium">Active processing</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-indigo-700 transition-colors duration-300">0</p>
                  <div className="bg-indigo-100 p-1 rounded-full group-hover:bg-indigo-200 transition-colors duration-300">
                    <Target className="h-3 w-3 text-indigo-600" />
                  </div>
                </div>
                <p className="text-sm font-semibold text-gray-700 group-hover:text-indigo-800 transition-colors duration-300">Partial</p>
                <p className="text-xs text-indigo-600 font-medium">Partially completed</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-red-50 via-rose-50 to-pink-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-red-700 transition-colors duration-300">0</p>
                  <div className="bg-red-100 p-1 rounded-full group-hover:bg-red-200 transition-colors duration-300">
                    <XIcon className="h-3 w-3 text-red-600" />
                  </div>
                </div>
                <p className="text-sm font-semibold text-gray-700 group-hover:text-red-800 transition-colors duration-300">Canceled</p>
                <p className="text-xs text-red-600 font-medium">Order canceled</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-pink-50 via-rose-50 to-red-100">
            ...
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-pink-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-pink-800 transition-colors duration-300">Refunded</p>
                <p className="text-xs text-pink-600 font-medium">Money returned</p>
              </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-indigo-600/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-indigo-600"></div>
            <div className="absolute top-2 right-2 bg-blue-500 text-white text-xs px-2 py-1 rounded-full font-semibold animate-pulse">ACTIVE</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-blue-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-blue-800 transition-colors duration-300">Processing</p>
                <p className="text-xs text-blue-600 font-medium">Being handled</p>
              </div>
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-4 rounded-2xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                <RefreshCcw className="h-8 w-8 text-white" />
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-100">
            ...
            <div className="absolute top-2 right-2 bg-amber-500 text-white text-xs px-2 py-1 rounded-full font-semibold animate-bounce">WAIT</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-amber-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-amber-800 transition-colors duration-300">Pending</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/20 to-green-600/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-green-600"></div>
            <div className="absolute top-2 right-2 bg-emerald-500 text-white text-xs px-2 py-1 rounded-full font-semibold animate-pulse">REPLY</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-emerald-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-emerald-800 transition-colors duration-300">Replied</p>
                <p className="text-xs text-emerald-600 font-medium">Response sent</p>
              </div>
              <div className="bg-gradient-to-br from-emerald-500 to-green-600 p-4 rounded-2xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-100">
            ...
            <div className="absolute top-2 right-2 bg-teal-500 text-white text-xs px-2 py-1 rounded-full font-semibold">SOLVE</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-teal-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-teal-800 transition-colors duration-300">Answered</p>
                <p className="text-xs text-teal-600 font-medium">Solution provided</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-red-50 via-rose-50 to-pink-100">
            <div className="absolute inset-0 bg-gradient-to-r from-red-600/20 to-rose-600/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-500 to-rose-600"></div>
            <div className="absolute top-2 right-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full font-semibold">STOP</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-red-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-red-800 transition-colors duration-300">Canceled</p>
                <p className="text-xs text-red-600 font-medium">Request canceled</p>
              </div>
              <div className="bg-gradient-to-br from-red-500 to-rose-600 p-4 rounded-2xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                <XIcon className="h-8 w-8 text-white" />
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-pink-50 via-rose-50 to-red-100">
            <div className="absolute inset-0 bg-gradient-to-r from-pink-600/20 to-rose-600/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 to-rose-600"></div>
            <div className="absolute top-2 right-2 bg-pink-500 text-white text-xs px-2 py-1 rounded-full font-semibold">BACK</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-pink-700 transition-colors duration-300">0</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-gray-50 via-slate-50 to-zinc-100">
            ...
            <div className="absolute top-2 right-2 bg-gray-500 text-white text-xs px-2 py-1 rounded-full font-semibold">DONE</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-gray-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-gray-800 transition-colors duration-300">Closed</p>
                <p className="text-xs text-gray-600 font-medium">Issue resolved</p>
              </div>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-100">
            ...
            <div className="absolute top-2 right-2 bg-orange-500 text-white text-xs px-2 py-1 rounded-full font-semibold animate-bounce">WAIT</div>
            <CardContent className="p-6 flex items-center justify-between relative z-10">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-4xl font-bold text-gray-800 group-hover:text-orange-700 transition-colors duration-300">0</p>
                ...
                <p className="text-sm font-semibold text-gray-700 group-hover:text-orange-800 transition-colors duration-300">Pending</p>
      ...
      <div className="mb-8">
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-white via-gray-50 to-purple-50 shadow-2xl">
          ...
          <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 p-4">
            ...
            <p className="text-indigo-100 text-sm">Most popular services and products</p>
          </CardHeader>
                ...
                <TableRow className="group hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 transition-all duration-300">
                  <TableCell className="text-center py-8" colSpan={6}>
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-purple-600 font-semibold text-lg">No data available</p>
                      <p className="text-gray-500 text-sm">Bestseller data will appear here once orders are placed</p>
                    </div>
                  </TableCell>
                </TableRow>
              </TableBody>
      ...
      <div className="mb-8">
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-white via-gray-50 to-blue-50 shadow-2xl">
          ...
          <CardHeader className="bg-gradient-to-r from-green-500 to-emerald-600 p-4">
            ...
            <p className="text-green-100 text-sm">Monitor and manage user registrations</p>
          </CardHeader>
          <CardContent className="p-0">
            <Table>
              <TableHeader>
                ...
                <TableRow className="group hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-300 border-b border-gray-100">
                  <TableCell className="font-semibold py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-gray-800 group-hover:text-green-700 transition-colors duration-300">munna</p>
                  ...
                  <TableCell className="group-hover:text-yellow-700 transition-colors duration-300">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">0 USD</span>
                    </div>
                  </TableCell>
                  <TableCell>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-purple-50 via-pink-50 to-rose-100">
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-800 group-hover:text-purple-700 transition-colors duration-300">munna</h3>
                  <p className="text-sm text-gray-600 group-hover:text-pink-600 transition-colors duration-300">VIP Customer</p>
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-800 group-hover:text-blue-700 transition-colors duration-300">User 2</h3>
                  <p className="text-sm text-gray-600 group-hover:text-indigo-600 transition-colors duration-300">Gold Member</p>
                  <div className="flex items-center gap-1 mt-1">
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
          ...
          <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100">
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-800 group-hover:text-emerald-700 transition-colors duration-300">User 3</h3>
                  <p className="text-sm text-gray-600 group-hover:text-green-600 transition-colors duration-300">Silver Member</p>
                  <div className="flex items-center gap-1 mt-1">
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
                    <Star className="h-4 w-4 text-yellow-500 fill-current" />
