...
export default function OrderDetailsPage() {
  ...
  const breadcrumbItems = [
    ...
    { title: `Order #${orderId?.slice(-8)}`, link: `/dashboard/admin/orders/${orderId}` },
  ];
      ...
      <div className="h-full space-y-6 p-6 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm">The requested order could not be found.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  {editMode ? (
                    <Input
                      ...
                      onChange={(e) => setEditForm(prev => ({ ...prev, startCount: e.target.value }))}
                      className="mt-1"
                    />
                  ) : (
                    <div className="font-semibold text-gray-900 mt-1">{order.startCount.toLocaleString()}</div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    <Input
                      ...
                      onChange={(e) => setEditForm(prev => ({ ...prev, remains: e.target.value }))}
                      className="mt-1"
                    />
                  ) : (
                    <div className="font-semibold text-gray-900 mt-1">{order.remains.toLocaleString()}</div>
                  )}
                </div>
              </div>
            </div>
        ...
        <Card className="relative overflow-hidden border-0 bg-white shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            >
              <Link href={`/dashboard/admin/orders/${orderId}/refill`}>
            ...
            >
              <Link href={`/dashboard/admin/orders/${orderId}/cancel`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="relative overflow-hidden border-0 bg-white shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="font-semibold text-gray-900 mt-1">{order.user.currency}</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-0 bg-white shadow-lg">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="text-sm font-medium text-gray-700">Service Rate</Label>
                <div className="font-semibold text-gray-900 mt-1">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="text-sm font-medium text-gray-700">USD Price</Label>
                <div className="font-semibold text-gray-900 mt-1">
                  ${order.usdPrice.toFixed(2)}
                </div>
              </div>
              <div>
                <Label className="text-sm font-medium text-gray-700">BDT Price</Label>
                <div className="font-semibold text-gray-900 mt-1">
      ...
      <Dialog open={statusUpdateDialogOpen} onOpenChange={setStatusUpdateDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Change the status of order #{orderId?.slice(-8)}. This may affect the user's balance.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete order #{orderId?.slice(-8)}? This action cannot be undone and will refund the user if the order was paid.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
