...
export default function BulkModifyServicesPage() {
  ...
  const breadcrumbItems = [
    ...
    { title: 'Modify Bulk Services', link: '/dashboard/admin/services/bulk-modify' },
  ];
  ...
  const handleBulkUpdate = async () => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(`Successfully updated ${selectedServices.length} services`);
        setSelectedServices([]);
        setBulkData({});
      ...
      <div className="flex items-center justify-between py-1">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Select and modify multiple services at once
          </p>
        </div>
        <Button 
          asChild 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-green-50 to-emerald-100">
          ...
          <CardContent className="p-6 flex items-center justify-between relative z-10">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <p className="text-3xl font-bold text-gray-800">{selectedServices.length}</p>
                <CheckSquare className="h-4 w-4 text-green-500" />
              </div>
              <p className="text-sm font-medium text-gray-600">Selected Services</p>
            </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-purple-50 to-violet-100">
          ...
          <CardContent className="p-6 flex items-center justify-between relative z-10">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <p className="text-3xl font-bold text-gray-800">{services.filter(s => s.status === 'active').length}</p>
        ...
        <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-orange-50 to-amber-100">
          ...
          <CardContent className="p-6 flex items-center justify-between relative z-10">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <p className="text-3xl font-bold text-gray-800">{filteredServices.length}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={bulkData.rate || ''}
                  onChange={(e) => setBulkData(prev => ({ ...prev, rate: parseFloat(e.target.value) || undefined }))}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setBulkData(prev => ({ ...prev, min_order: parseInt(e.target.value) || undefined }))}
                  className="transition-all duration-200 focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setBulkData(prev => ({ ...prev, max_order: parseInt(e.target.value) || undefined }))}
                  className="transition-all duration-200 focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) => setBulkData(prev => ({ ...prev, status: e.target.value || undefined }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{service.category.category_name}</p>
                    </div>
                  </div>
