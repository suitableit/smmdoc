...
export default function page() {
  ...
  const breadcrumbItems = [
    { title: 'Services Management', link: '/dashboard/admin/services' },
  ];
  ...
  const quickActions = [
    ...
    },
    {
      ...
      href: '/dashboard/admin/analytics/services',
    ...
    },
    {
      ...
      href: '/dashboard/admin/services/bulk-import',
    ...
    },
    {
      ...
      href: '/dashboard/admin/services/settings',
  ...
  return (
    <div className="h-full space-y-6">
      ...
      <div className="flex items-center justify-between py-1">
        ...
        <Button asChild variant="default" size="sm" className="shadow-lg hover:shadow-xl transition-all duration-200">
          <Link
            href="/dashboard/admin/services/create-services"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {serviceStats.map((stat, index) => (
          <Card key={index} className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
            <div className={`absolute inset-0 bg-gradient-to-br ${stat.bgGradient} dark:bg-gradient-to-br dark:${stat.darkBgGradient} opacity-50`} />
            <CardContent className="relative p-6">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-full bg-gradient-to-br ${stat.gradient} text-white shadow-lg group-hover:scale-110 transition-transform duration-200`}>
                  {stat.icon}
                </div>
              </div>
            </CardContent>
              ...
              <Link key={index} href={action.href}>
                <div className="p-4 rounded-lg border border-border hover:border-primary/50 transition-all duration-200 hover:shadow-md group cursor-pointer">
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`p-2 rounded-md ${action.color} text-white group-hover:scale-110 transition-transform duration-200`}>
                      {action.icon}
                    </div>
