          ...
          <div className="bg-[#f3f3f3] mx-6 mb-6 px-6 py-4 rounded-lg">
            <div className="text-center">
              ...
              <h2 className="text-lg font-semibold text-gray-800 leading-tight">
                {service?.name ||
                  'TikTok ~ Followers ~ [100% Real Users] ~ Max 10M ~ 100k/days ~ Instant ~ NO REFILL'}
              </h2>
            </div>
          </div>
            ...
            <div className="space-y-4 text-sm text-gray-700">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    • When the service is experiencing high demand, the starting
                    speed may vary.
                  </p>
                  <p>
                    • Please avoid placing a second order on the same link until
                    the current order is fully completed in the system.
                  </p>
                  <p>
                    • If you encounter any issues with the service, kindly reach
                    out to our support team for assistance.
                  </p>
                  <p>
                    • Do not place orders for private accounts or private links.
                    Orders for private content will not be processed and may not
                    be refunded.
                  </p>
                </div>
              </div>
