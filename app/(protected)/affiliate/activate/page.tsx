          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                <FaUsers className="w-5 h-5 text-[var(--primary)]" />
                How it Works
              </h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[var(--primary)] rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                    1
                  </div>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Get your unique referral link after activation
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[var(--primary)] rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Share your link through social media, blogs, or direct outreach
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[var(--primary)] rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Earn 1% commission when referred users place orders
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[var(--primary)] rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Get paid monthly when you reach $100 minimum
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                <FaShieldAlt className="w-5 h-5 text-[var(--primary)]" />
                Requirements
              </h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  <FaCheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Agreement to affiliate terms and conditions
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <FaCheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start gap-3">
                  <FaCheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    No use of your own referral link on your account
                  </p>
                </div>
              </div>
            </div>
